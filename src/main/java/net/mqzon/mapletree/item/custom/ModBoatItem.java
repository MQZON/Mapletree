package net.mqzon.mapletree.item.custom;
...
public class ModBoatItem extends BoatItem {
    ...
    public ModBoatItem(boolean pHasChest, Properties pProperties, WoodType pType) {
    ...
    private Boat getBoat(Level level, HitResult hitResult) {
        return HAS_CHEST
                ? new ModChestBoatEntity(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z, WOOD_TYPE)
                : new ModBoatEntity(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z, WOOD_TYPE);
    }
}
