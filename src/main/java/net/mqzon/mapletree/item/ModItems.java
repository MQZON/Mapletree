...
public class ModItems {
    ...
    public static final Item SYRUP_BOTTLE = registerItem("syrup_bottle", new ModDrinkItem
            (new Item.Settings().food(ModFoodComponents.SYRUP_BOTTLE).maxCount(16).recipeRemainder(Items.GLASS_BOTTLE)));
