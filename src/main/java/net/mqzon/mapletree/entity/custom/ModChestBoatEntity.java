...
public class ModChestBoatEntity extends ChestBoat {
    private static final EntityDataAccessor<String> WOOD_TYPE =
            SynchedEntityData.defineId(ModChestBoatEntity.class, EntityDataSerializers.STRING);

    public ModChestBoatEntity(EntityType<? extends Boat> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public ModChestBoatEntity(Level level, double x, double y, double z, String woodType) {
        this(ModEntityTypes.MAPLE_CHEST_BOAT.get(), level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
        this.zo = z;
